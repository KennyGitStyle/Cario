...
public class AuctionControllerTests : IAsyncLifetime
{
    ...
    public AuctionControllerTests(CustomWebAppFactory appFactory)
    {
    ...
    [Fact]
    public async Task GetAuctions_ShouldReturn9Auctions()
    {
        // arrange
    ...
    [Fact]
    public async Task CreateAuction_WithInvalidGuid_ShouldReturn400()
    {
        // arrange
