...
public class DbInitializer
{
    public static async Task InitDb(WebApplication app)
    {
        ...
        var context = scope.ServiceProvider.GetService<AuctionServiceDbContext>();

         await SeedDataAsync(context);
    }

    private static async Task SeedDataAsync(AuctionServiceDbContext context)
    {  
        ...
        var auctions = GetSampleAuctions(); // Create a method to define the sample data
        context.AddRange(auctions); // Use AddRange directly (not async)
        await context.SaveChangesAsync();
    }

    private static List<Auction> GetSampleAuctions()
    {
